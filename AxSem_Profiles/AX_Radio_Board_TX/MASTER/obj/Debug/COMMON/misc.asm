...
;------------------------------------------------------------
	...
	C$misc.c$74$0$0 ==.
;	..\COMMON\misc.c:74: void lcd2_display_radio_error(uint8_t err)
;	-----------------------------------------
...
_lcd2_display_radio_error:
	...
	mov	r7,dpl
	C$misc.c$76$1$0 ==.
;	..\COMMON\misc.c:76: const struct errtbl __code *p = errtbl;
	mov	r5,#_errtbl
	mov	r6,#(_errtbl >> 8)
	C$misc.c$77$1$337 ==.
;	..\COMMON\misc.c:77: do {
...
00103$:
	C$misc.c$78$2$338 ==.
;	..\COMMON\misc.c:78: if (p->errcode == err) {
	mov	dpl,r3
	mov	dph,r4
	clr	a
	movc	a,@a+dptr
	...
	cjne	a,ar7,00102$
	C$misc.c$79$3$339 ==.
;	..\COMMON\misc.c:79: display_setpos(0);
	mov	dpl,#0x00
	push	ar6
	push	ar5
	lcall	_lcd2_setpos
	...
	pop	ar6
	C$misc.c$80$3$339 ==.
;	..\COMMON\misc.c:80: display_writestr(p->msg);
	mov	dpl,r5
	mov	dph,r6
	inc	dptr
	clr	a
...
;	..\COMMON\misc.c:83: ++p;
	...
	mov	ar6,r4
	C$misc.c$84$1$337 ==.
;	..\COMMON\misc.c:84: } while (p->errcode != AXRADIO_ERR_NOERROR);
	mov	dpl,r3
	mov	dph,r4
	clr	a
	movc	a,@a+dptr
...
;------------------------------------------------------------
	...
	C$misc.c$102$1$337 ==.
;	..\COMMON\misc.c:102: void dbglink_display_radio_error(uint8_t err)
;	-----------------------------------------
;	 function dbglink_display_radio_error
;	-----------------------------------------
_dbglink_display_radio_error:
	C$misc.c$104$1$337 ==.
;	..\COMMON\misc.c:104: const struct errtbl __code *p = errtbl;
	C$misc.c$105$1$341 ==.
;	..\COMMON\misc.c:105: if (!(DBGLNKSTAT & 0x10))
	mov	a,_DBGLNKSTAT
	jb	acc.4,00109$
	C$misc.c$106$1$341 ==.
;	..\COMMON\misc.c:106: return;
	C$misc.c$107$1$341 ==.
;	..\COMMON\misc.c:107: do {
	sjmp	00106$
00109$:
	mov	r6,#_errtbl
	mov	r7,#(_errtbl >> 8)
...
;	..\COMMON\misc.c:114: ++p;
	...
	mov	r7,a
	C$misc.c$115$1$341 ==.
;	..\COMMON\misc.c:115: } while (p->errcode != AXRADIO_ERR_NOERROR);
	mov	dpl,r6
	mov	dph,r7
	clr	a
	movc	a,@a+dptr
...
;------------------------------------------------------------
	...
	C$misc.c$121$1$341 ==.
;	..\COMMON\misc.c:121: static void delayms_callback(struct wtimer_desc __xdata *desc)
;	-----------------------------------------
;	 function delayms_callback
;	-----------------------------------------
_delayms_callback:
	C$misc.c$124$1$345 ==.
;	..\COMMON\misc.c:124: delaymstimer.handler = 0;
...
;------------------------------------------------------------
	G$delay_ms$0$0 ==.
	C$misc.c$127$1$345 ==.
;	..\COMMON\misc.c:127: __reentrantb void delay_ms(uint16_t ms) __reentrant
;	-----------------------------------------
;	 function delay_ms
;	-----------------------------------------
_delay_ms:
	...
	mov	r7,dph
	C$misc.c$131$1$347 ==.
;	..\COMMON\misc.c:131: wtimer_remove(&delaymstimer);
...
;	..\COMMON\misc.c:132: x = ms;
	...
	mov	@r0,#0x00
	C$misc.c$133$1$347 ==.
;	..\COMMON\misc.c:133: delaymstimer.time = ms >> 1;
	mov	a,r7
	clr	c
	rrc	a
	xch	a,r6
...
;	..\COMMON\misc.c:134: x <<= 3;
	...
	mov	@r0,a
	C$misc.c$135$1$347 ==.
;	..\COMMON\misc.c:135: delaymstimer.time -= x;
	mov	r0,_bp
	inc	r0
	mov	a,r4
	clr	c
...
;	..\COMMON\misc.c:136: x <<= 3;
	...
	mov	@r0,a
	C$misc.c$137$1$347 ==.
;	..\COMMON\misc.c:137: delaymstimer.time += x;
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	add	a,r4
...
;	..\COMMON\misc.c:138: x <<= 2;
	...
	mov	@r0,a
	C$misc.c$139$1$347 ==.
;	..\COMMON\misc.c:139: delaymstimer.time += x;
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	add	a,r4
	...
	movx	@dptr,a
	C$misc.c$140$1$347 ==.
;	..\COMMON\misc.c:140: delaymstimer.handler = delayms_callback;
	mov	dptr,#(_delaymstimer + 0x0002)
	...
	movx	@dptr,a
	C$misc.c$141$1$347 ==.
;	..\COMMON\misc.c:141: wtimer1_addrelative(&delaymstimer);
	mov	dptr,#_delaymstimer
	lcall	_wtimer1_addrelative
	C$misc.c$142$1$347 ==.
;	..\COMMON\misc.c:142: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$misc.c$143$1$347 ==.
;	..\COMMON\misc.c:143: do {
00101$:
	C$misc.c$144$2$348 ==.
;	..\COMMON\misc.c:144: wtimer_idle(WTFLAG_CANSTANDBY);
	mov	dpl,#0x02
	lcall	_wtimer_idle
	C$misc.c$145$2$348 ==.
;	..\COMMON\misc.c:145: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$misc.c$146$1$347 ==.
;	..\COMMON\misc.c:146: } while (delaymstimer.handler);
	mov	dptr,#(_delaymstimer + 0x0002)
	movx	a,@dptr
	mov	r6,a
	inc	dptr
