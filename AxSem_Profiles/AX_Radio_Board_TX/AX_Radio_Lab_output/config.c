...
// TX: fcarrier=436.500MHz dev= 24.000kHz br= 96.000kBit/s pwr= 10.0dBm
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 284, 220, 274 };// 8.651ms, 6.698ms, 8.346ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 317, 189, 297 }; // 9.658ms, 5.752ms, 9.048ms
