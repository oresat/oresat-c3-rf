...
// TX: fcarrier=457.000MHz dev= 30.000kHz br=120.000kBit/s pwr= 10.0dBm
// RX: fcarrier=457.000MHz bw=180.000kHz br=120.000kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_IFFREQ1        ,                              			0x11);
	radio_write8(AX5043_REG_IFFREQ0        ,                              			0x98);
	radio_write8(AX5043_REG_DECIMATION     ,                              			0x01);
	...
	radio_write8(AX5043_REG_MAXRFOFFSET0   ,                              			0xBE);
	...
	radio_write8(AX5043_REG_AGCGAIN0       ,                              			0x83);
	...
	radio_write8(AX5043_REG_FREQUENCYGAINC0,                              			0x05);
	radio_write8(AX5043_REG_FREQUENCYGAIND0,                              			0x05);
	...
	radio_write8(AX5043_REG_AGCGAIN1       ,                              			0x83);
	...
	radio_write8(AX5043_REG_FREQUENCYGAINC1,                              			0x05);
	radio_write8(AX5043_REG_FREQUENCYGAIND1,                              			0x05);
	...
	radio_write8(AX5043_REG_FREQUENCYGAINC3,                              			0x09);
	radio_write8(AX5043_REG_FREQUENCYGAIND3,                              			0x09);
	...
	radio_write8(AX5043_REG_FSKDEV1        ,                              			0x7A);
	radio_write8(AX5043_REG_FSKDEV0        ,                              			0xE1);
	radio_write8(AX5043_REG_MODCFGA        ,                              			0x06);
	radio_write8(AX5043_REG_TXRATE2        ,                              			0x01);
	radio_write8(AX5043_REG_TXRATE1        ,                              			0xEB);
	radio_write8(AX5043_REG_TXRATE0        ,                              			0x85);
	...
	radio_write8(AX5043_REG_BBTUNE         ,                              			0x02);
	...
	radio_write8(AX5043_REG_RSSIABSTHR     ,                              			0xEB);
...
__reentrantb void ax5043_set_registers_rxcont_singleparamset(void) __reentrant
{
	...
	radio_write8(AX5043_REG_AGCGAIN3,                 0xA5);
}
...
const uint32_t __code axradio_phy_chanfreq[1] = { 0x1c900001 };
const uint16_t __code axradio_phy_chanpllrnginit[1] = { 0x08 };
const uint8_t __code axradio_phy_chanvcoiinit[1] = { 0x96 };
...
const int32_t __code axradio_phy_maxfreqoffset = 2875;
...
const int8_t __code axradio_phy_rssireference = 0x05 + 64;
...
const uint16_t __code axradio_phy_preamble_wor_longlen = 112; // wor_longlen + wor_len totals to 240.0ms plus 32bits
...
const uint8_t __code axradio_phy_preamble_appendbits = 4;
...
const uint32_t __code axradio_framing_ack_timeout = 4; // 3.9ms in wtimer0 units (640Hz)
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 137, 89, 134 };// 4.151ms, 2.686ms, 4.059ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 151, 55, 145 }; // 4.578ms, 1.649ms, 4.395ms
const uint32_t __code axradio_sync_slave_rxtimeout = 44; // 1.3ms, maximum duration of a packet
