...
S:Lmain.process_ber$fourfsk$1$343({1}SC:U),R,0,0,[r5]
S:Lmain.process_ber$i$2$344({1}SC:U),R,0,0,[r3]
S:Lmain.process_ber$p$3$346({2}DX,SC:U),R,0,0,[r6,r7]
S:Lmain.process_ber$databyte$6$349({1}SC:U),E,0,0
S:Lmain.process_ber$databyte$5$350({1}SC:U),R,0,0,[r4]
...
S:Lmain.axradio_statuschange$i$6$379({1}SC:U),R,0,0,[]
S:Lmain.axradio_statuschange$p$7$380({2}DX,SC:U),R,0,0,[]
