...
// TX: fcarrier=436.500MHz dev= 24.000kHz br= 96.000kBit/s pwr= 15.0dBm
// RX: fcarrier=436.500MHz bw=144.000kHz br= 96.000kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_IFFREQ0        ,                              			0xE5);
	...
	radio_write8(AX5043_REG_FSKDEV1        ,                              			0x20);
	radio_write8(AX5043_REG_FSKDEV0        ,                              			0xC5);
	radio_write8(AX5043_REG_MODCFGA        ,                              			0x06);
	radio_write8(AX5043_REG_TXRATE2        ,                              			0x00);
	radio_write8(AX5043_REG_TXRATE1        ,                              			0x83);
	radio_write8(AX5043_REG_TXRATE0        ,                              			0x12);
...
const uint16_t __code axradio_phy_preamble_wor_longlen = 91; // wor_longlen + wor_len totals to 240.0ms plus 400bits
...
const uint8_t __code axradio_framing_lenoffs = 10;
...
const uint32_t __code axradio_framing_ack_timeout = 7; // 8.1ms in wtimer0 units (640Hz)
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 284, 220, 274 };// 8.650ms, 6.697ms, 8.344ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 317, 189, 297 }; // 9.657ms, 5.751ms, 9.045ms
const uint32_t __code axradio_sync_slave_rxtimeout = 181; // 5.5ms, maximum duration of a packet
