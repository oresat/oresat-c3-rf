...
;	..\AX_Radio_Lab_output\config.c:22: radio_write8(AX5043_REG_WAKEUPXOEARLY  ,                              			0x01);
	...
	movx	@dptr,a
	C$config.c$23$2$180 ==.
;	..\AX_Radio_Lab_output\config.c:23: radio_write8(AX5043_REG_IFFREQ1        ,                              			0x0A);
	mov	dptr,#0x4100
	mov	a,#0x0a
	movx	@dptr,a
	C$config.c$24$2$181 ==.
;	..\AX_Radio_Lab_output\config.c:24: radio_write8(AX5043_REG_IFFREQ0        ,                              			0xE5);
	mov	dptr,#0x4101
	mov	a,#0xe5
	movx	@dptr,a
	C$config.c$25$2$182 ==.
...
;	..\AX_Radio_Lab_output\config.c:87: radio_write8(AX5043_REG_FSKDEV2        ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$88$2$245 ==.
;	..\AX_Radio_Lab_output\config.c:88: radio_write8(AX5043_REG_FSKDEV1        ,                              			0x20);
	mov	dptr,#0x4162
	mov	a,#0x20
	movx	@dptr,a
	C$config.c$89$2$246 ==.
;	..\AX_Radio_Lab_output\config.c:89: radio_write8(AX5043_REG_FSKDEV0        ,                              			0xC5);
	mov	dptr,#0x4163
	mov	a,#0xc5
	movx	@dptr,a
	C$config.c$90$2$247 ==.
...
;	..\AX_Radio_Lab_output\config.c:91: radio_write8(AX5043_REG_TXRATE2        ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$92$2$249 ==.
;	..\AX_Radio_Lab_output\config.c:92: radio_write8(AX5043_REG_TXRATE1        ,                              			0x83);
	mov	dptr,#0x4166
	mov	a,#0x83
	movx	@dptr,a
	C$config.c$93$2$250 ==.
;	..\AX_Radio_Lab_output\config.c:93: radio_write8(AX5043_REG_TXRATE0        ,                              			0x12);
	mov	dptr,#0x4167
	mov	a,#0x12
	movx	@dptr,a
	C$config.c$94$2$251 ==.
...
;	..\AX_Radio_Lab_output\config.c:97: radio_write8(AX5043_REG_PLLRNGCLK      ,                              			0x05);
	...
	movx	@dptr,a
	C$config.c$98$2$255 ==.
;	..\AX_Radio_Lab_output\config.c:98: radio_write8(AX5043_REG_BBTUNE         ,                              			0x03);
	mov	dptr,#0x4188
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$99$2$256 ==.
...
;	..\AX_Radio_Lab_output\config.c:102: radio_write8(AX5043_REG_PKTLENOFFSET   ,                              			0x0A);
	mov	dptr,#0x4202
	mov	a,#0x0a
	movx	@dptr,a
...
_axradio_sync_slave_rxadvance:
	.byte #0x1c,#0x01,#0x00,#0x00	; 284
	.byte #0xdc,#0x00,#0x00,#0x00	; 220
	.byte #0x12,#0x01,#0x00,#0x00	; 274
G$axradio_sync_slave_rxwindow$0$0 == .
_axradio_sync_slave_rxwindow:
	.byte #0x3d,#0x01,#0x00,#0x00	; 317
	.byte #0xbd,#0x00,#0x00,#0x00	; 189
	.byte #0x29,#0x01,#0x00,#0x00	; 297
G$axradio_sync_slave_rxtimeout$0$0 == .
_axradio_sync_slave_rxtimeout:
	.byte #0xb5,#0x00,#0x00,#0x00	; 181
