...
// TX: fcarrier=505.000MHz dev= 30.000kHz br=120.000kBit/s pwr= 10.0dBm
// RX: fcarrier=505.000MHz bw=180.000kHz br=120.000kBit/s
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 137, 89, 134 };// 4.151ms, 2.686ms, 4.060ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 151, 55, 145 }; // 4.579ms, 1.649ms, 4.397ms
