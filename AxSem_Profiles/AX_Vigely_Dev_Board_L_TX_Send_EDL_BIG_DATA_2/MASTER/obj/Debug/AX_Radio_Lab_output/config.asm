...
;	..\AX_Radio_Lab_output\config.c:102: radio_write8(AX5043_REG_PKTLENOFFSET   ,                              			0xF0);
	mov	dptr,#0x4202
	mov	a,#0xf0
	movx	@dptr,a
	C$config.c$103$2$260 ==.
;	..\AX_Radio_Lab_output\config.c:103: radio_write8(AX5043_REG_PKTMAXLEN      ,                              			0xF0);
	mov	dptr,#0x4203
	movx	@dptr,a
