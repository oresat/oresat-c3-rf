...
;--------------------------------------------------------
	.area DSEG    (DATA)
G$init_synth_only_once$0$0==.
_init_synth_only_once::
	.ds 1
G$pkt_counter$0$0==.
_pkt_counter::
	.ds 2
...
_coldstart::
	.ds 1
Lmain.si_write_reg$data$1$404==.
_si_write_reg_PARM_2:
	.ds 4
Lmain.main$saved_button_state$1$436==.
_main_saved_button_state_1_436:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;saved_button_state        Allocated with name '_main_saved_button_state_1_436'
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$main.c$368$1$436 ==.
;	main.c:368: static uint8_t __data saved_button_state = 0xFF;
	mov	_main_saved_button_state_1_436,#0xff
	C$main.c$78$1$436 ==.
;	main.c:78: uint8_t init_synth_only_once = 1;    /* *.*.*. OreSat */
	mov	_init_synth_only_once,#0x01
	C$main.c$80$1$436 ==.
...
;------------------------------------------------------------
	...
	C$main.c$88$0$0 ==.
;	main.c:88: static void pwrmgmt_irq(void) __interrupt(INT_POWERMGMT)
;	-----------------------------------------
...
_pwrmgmt_irq:
	...
	mov	psw,#0x00
	C$main.c$90$1$0 ==.
;	main.c:90: uint8_t pc = PCON;
	C$main.c$92$1$364 ==.
;	main.c:92: if (!(pc & 0x80))
	mov	a,_PCON
	mov	r7,a
	jb	acc.7,00102$
	C$main.c$93$1$364 ==.
...
00102$:
	C$main.c$95$1$364 ==.
;	main.c:95: GPIOENABLE = 0;
	mov	dptr,#_GPIOENABLE
	clr	a
	movx	@dptr,a
	C$main.c$96$1$364 ==.
;	main.c:96: IE = EIE = E2IE = 0;
...
;------------------------------------------------------------
	...
	C$main.c$102$1$364 ==.
;	main.c:102: static void transmit_packet(void)
;	-----------------------------------------
;	 function transmit_packet
;	-----------------------------------------
_transmit_packet:
	C$main.c$106$1$366 ==.
;	main.c:106: ++pkt_counter;
	inc	_pkt_counter
	clr	a
...
;	main.c:109: if (framing_insert_counter)
	...
	jz	00102$
	C$main.c$111$2$367 ==.
;	main.c:111: demo_packet_[framing_counter_pos] = pkt_counter & 0xFF ;
	...
	movx	@dptr,a
	C$main.c$112$2$367 ==.
;	main.c:112: demo_packet_[framing_counter_pos+1] = (pkt_counter>>8) & 0xFF;
	mov	a,r7
	inc	a
	add	a,#_transmit_packet_demo_packet__1_366
	mov	dpl,a
...
00102$:
	C$main.c$115$1$366 ==.
;	main.c:115: axradio_transmit(&remoteaddr, demo_packet_, sizeof(demo_packet));
	...
	mov	_axradio_transmit_PARM_3,#0xf0
...
;------------------------------------------------------------
	...
	C$main.c$118$1$366 ==.
;	main.c:118: static void display_transmit_packet(void)
;	-----------------------------------------
;	 function display_transmit_packet
;	-----------------------------------------
_display_transmit_packet:
	C$main.c$120$1$369 ==.
;	main.c:120: if (pkt_counter == 1)
	mov	a,#0x01
	cjne	a,_pkt_counter,00108$
	dec	a
...
00109$:
	C$main.c$122$2$370 ==.
;	main.c:122: display_setpos(0x40);
	mov	dpl,#0x40
	lcall	_lcd2_setpos
	C$main.c$123$2$370 ==.
;	main.c:123: display_writestr("TX    ");
	mov	dptr,#___str_0
	mov	b,#0x80
	lcall	_lcd2_writestr
00102$:
	C$main.c$132$1$369 ==.
;	main.c:132: display_setpos(0x4c);
	mov	dpl,#0x4c
	lcall	_lcd2_setpos
	C$main.c$133$1$369 ==.
;	main.c:133: display_writehex16(pkt_counter, 4, WRNUM_PADZERO);
	mov	a,#0x08
	push	acc
	rr	a
	push	acc
...
;------------------------------------------------------------
	...
	C$main.c$145$1$369 ==.
;	main.c:145: void axradio_statuschange(struct axradio_status __xdata *st)
;	-----------------------------------------
;	 function axradio_statuschange
;	-----------------------------------------
_axradio_statuschange:
	C$main.c$158$1$372 ==.
;	main.c:158: switch (st->status)
	mov	r6,dpl
	mov  r7,dph
	movx	a,@dptr
	mov	r5,a
...
00105$:
	setb	_PORTC_3
	C$main.c$163$2$373 ==.
;	main.c:163: if (st->error == AXRADIO_ERR_RETRANSMISSION)
	mov	dpl,r6
	mov	dph,r7
	inc	dptr
	movx	a,@dptr
...
00120$:
	clr	_PORTC_3
	C$main.c$180$2$373 ==.
;	main.c:180: if (st->error == AXRADIO_ERR_NOERROR)
	mov	dpl,r6
	mov	dph,r7
	inc	dptr
	movx	a,@dptr
...
00138$:
	C$main.c$197$2$373 ==.
;	main.c:197: else if (st->error == AXRADIO_ERR_TIMEOUT)
	cjne	r5,#0x03,00139$
	C$main.c$199$5$385 ==.
;	main.c:199: led2_on();
	setb	_PORTA_2
00139$:
	C$main.c$212$2$373 ==.
;	main.c:212: if (st->error == AXRADIO_ERR_BUSY)
	cjne	r5,#0x02,00149$
	C$main.c$213$4$387 ==.
;	main.c:213: led3_on();
	setb	_PORTA_5
...
;	main.c:217: break;
	C$main.c$227$2$373 ==.
;	main.c:227: case AXRADIO_STAT_CHANNELSTATE:
	sjmp	00173$
00155$:
	C$main.c$228$2$373 ==.
;	main.c:228: if (st->u.cs.busy)
	mov	a,#0x06
	add	a,r6
	mov	r6,a
	clr	a
...
;------------------------------------------------------------
	...
	C$main.c$240$1$372 ==.
;	main.c:240: void enable_radio_interrupt_in_mcu_pin(void)
;	-----------------------------------------
...
;------------------------------------------------------------
	...
	C$main.c$245$1$395 ==.
;	main.c:245: void disable_radio_interrupt_in_mcu_pin(void)
;	-----------------------------------------
...
;------------------------------------------------------------
	...
	C$main.c$250$1$397 ==.
;	main.c:250: static void wakeup_callback(struct wtimer_desc __xdata *desc)
;	-----------------------------------------
;	 function wakeup_callback
;	-----------------------------------------
_wakeup_callback:
	C$main.c$254$1$399 ==.
;	main.c:254: wakeup_desc.time += wtimer0_correctinterval(WTIMER0_PERIOD);
	...
	movx	@dptr,a
	C$main.c$255$1$399 ==.
;	main.c:255: wtimer0_addabsolute(&wakeup_desc);
	mov	dptr,#_wakeup_desc
	lcall	_wtimer0_addabsolute
	C$main.c$256$1$399 ==.
;	main.c:256: transmit_packet();
	lcall	_transmit_packet
	C$main.c$257$1$399 ==.
;	main.c:257: display_transmit_packet();
...
;------------------------------------------------------------
	...
	C$main.c$261$1$399 ==.
;	main.c:261: uint8_t _sdcc_external_startup(void)
;	-----------------------------------------
;	 function _sdcc_external_startup
;	-----------------------------------------
__sdcc_external_startup:
	C$main.c$263$1$401 ==.
;	main.c:263: LPXOSCGM = 0x8A;
	mov	dptr,#_LPXOSCGM
	mov	a,#0x8a
	movx	@dptr,a
	C$main.c$264$2$402 ==.
;	main.c:264: wtimer0_setclksrc(WTIMER0_CLKSRC, WTIMER0_PRESCALER);
	mov	dpl,#0x09
	lcall	_wtimer0_setconfig
	C$main.c$265$2$403 ==.
;	main.c:265: wtimer1_setclksrc(CLKSRC_FRCOSC, 7);
	mov	dpl,#0x38
	lcall	_wtimer1_setconfig
	C$main.c$267$1$401 ==.
;	main.c:267: LPOSCCONFIG = 0x09; /* Slow, PRESC /1, no cal. Does NOT enable LPOSC. LPOSC is enabled upon configuring WTCFGA (MODE_TX_PERIODIC and receive_ack() ) */
	mov	dptr,#_LPOSCCONFIG
	mov	a,#0x09
	movx	@dptr,a
	C$main.c$269$1$401 ==.
;	main.c:269: coldstart = !(PCON & 0x40);
	mov	a,_PCON
	mov	c,acc[6]
	cpl	c
	...
	mov	_coldstart,a
	C$main.c$271$1$401 ==.
;	main.c:271: ANALOGA = 0x18; /* PA[3,4] LPXOSC, other PA are used as digital pins */
	mov	dptr,#_ANALOGA
	mov	a,#0x18
	movx	@dptr,a
	C$main.c$272$1$401 ==.
...
;	main.c:275: PORTC = 0xF3 | (PINC & 0x08); 	/* set PC0 = 1 (LCD SEL), PC1 = 1 (LCD SCK), PC2 = 0 (LCD MOSI), PC3 =0 (LED), enable pull-ups for PC[4..7] which are not bonded Mind: PORTC[0:1] is set to 0x3 by lcd2_portinit() */
	...
	mov	_PORTC,a
	C$main.c$277$1$401 ==.
;	main.c:277: PORTR = 0xCB; /* overwritten by ax504x_reset, ax504x_comminit() */
	mov	_PORTR,#0xcb
	C$main.c$279$1$401 ==.
;	main.c:279: DIRA = 0x27; /* output 0 on PA[0,1,2,5] to prevent current consumption in all DIP switch states. Other PA are inputs, PA[3,4] (LPXOSC) must have disabled digital output drivers */
	mov	_DIRA,#0x27
	C$main.c$280$1$401 ==.
;	main.c:280: DIRB = 0x03; /* PB[0,1] are outputs (LCD RS, LCD RST), PB[2..7] are inputs (PB[2,3] for buttons,  PB[4..7]  unused) */
	mov	_DIRB,#0x03
	C$main.c$281$1$401 ==.
;	main.c:281: DIRC = 0x0F; /* PC[0..3] are outputs (LCD SEL, LCD,SCK, LCD MOSI, LED), PC[4..7] are inputs (not bonded). */
	mov	_DIRC,#0x0f
	C$main.c$282$1$401 ==.
;	main.c:282: DIRR = 0x15; /* overwritten by ax504x_reset, ax504x_comminit() */
	mov	_DIRR,#0x15
	C$main.c$283$1$401 ==.
;	main.c:283: axradio_setup_pincfg1();
...
;	main.c:286: EIE = 0x00;
	mov	_EIE,#0x00
	C$main.c$287$1$401 ==.
;	main.c:287: E2IE = 0x00;
	mov	_E2IE,#0x00
	C$main.c$289$1$401 ==.
;	main.c:289: display_portinit();
	lcall	_lcd2_portinit
	C$main.c$290$1$401 ==.
;	main.c:290: GPIOENABLE = 1; /* unfreeze GPIO */
	mov	dptr,#_GPIOENABLE
	mov	a,#0x01
	movx	@dptr,a
	C$main.c$291$1$401 ==.
;	main.c:291: return !coldstart; /* coldstart -> return 0 -> var initialization; start from sleep -> return 1 -> no var initialization */
	mov	a,_coldstart
	cjne	a,#0x01,00109$
00109$:
	mov  __sdcc_external_startup_sloc0_1_0,c
...
;------------------------------------------------------------
	...
	C$main.c$296$1$401 ==.
;	main.c:296: static void si_write_reg(uint8_t address, uint32_t data)
;	-----------------------------------------
...
_si_write_reg:
	mov	r7,dpl
	C$main.c$302$1$405 ==.
;	main.c:302: data = (data << 14) | (address << 10);
	...
	C$main.c$307$3$407 ==.
;	main.c:307: led2_off(); //palClearLine(LINE_SI_SENB);
	clr	_PORTA_2
	C$main.c$311$1$405 ==.
;	main.c:311: led1_off(); //palClearLine(LINE_SI_SCLK);
	mov	r6,#0x00
	mov	r7,#0x00
00110$:
	clr	_PORTA_0
	C$main.c$312$2$408 ==.
;	main.c:312: delay_ms(1);
	mov	dptr,#0x0001
	push	ar7
	push	ar6
	lcall	_delay_ms
	...
	pop	ar7
	C$main.c$313$2$408 ==.
;	main.c:313: sdata = data & mask;
	mov	a,(_si_write_reg_PARM_2 + 3)
	jnb	acc.7,00122$
	C$main.c$314$2$408 ==.
;	main.c:314: if(sdata > 0){
	C$main.c$316$5$413 ==.
;	main.c:316: led3_on(); //palSetLine(LINE_SI_SDATA);
	setb	_PORTA_5
	C$main.c$320$3$414 ==.
;	main.c:320: led3_off(); //palClearLine(LINE_SI_SDATA);
	sjmp	00127$
00122$:
	clr	_PORTA_5
00127$:
	C$main.c$322$2$408 ==.
;	main.c:322: delay_ms(1);
	mov	dptr,#0x0001
	push	ar7
	push	ar6
	lcall	_delay_ms
	C$main.c$323$4$418 ==.
;	main.c:323: led1_on(); //palSetLine(LINE_SI_SCLK);
	setb	_PORTA_0
	C$main.c$324$2$408 ==.
;	main.c:324: delay_ms(1);
	mov	dptr,#0x0001
	lcall	_delay_ms
	C$main.c$325$2$408 ==.
;	main.c:325: data = data <<1;
	mov	a,_si_write_reg_PARM_2
	...
	mov	(_si_write_reg_PARM_2 + 3),a
	C$main.c$326$2$408 ==.
;	main.c:326: delay_ms(1);
	mov	dptr,#0x0001
	lcall	_delay_ms
	pop	ar6
	pop	ar7
	C$main.c$309$1$405 ==.
;	main.c:309: for(i=0; i<22;i++)
	inc	r6
	cjne	r6,#0x00,00156$
	inc	r7
00156$:
	...
	jc	00110$
	C$main.c$329$3$420 ==.
;	main.c:329: led2_on(); //palSetLine(LINE_SI_SENB);
	setb	_PORTA_2
	C$main.c$331$1$405 ==.
...
;------------------------------------------------------------
	...
	C$main.c$335$1$405 ==.
;	main.c:335: static void synth_init(void)
;	-----------------------------------------
;	 function synth_init
;	-----------------------------------------
_synth_init:
	C$main.c$349$3$424 ==.
;	main.c:349: led2_on(); //palSetLine(LINE_SI_SENB);
	setb	_PORTA_2
	C$main.c$350$3$426 ==.
;	main.c:350: led3_on(); //palSetLine(LINE_SI_SDATA);
	setb	_PORTA_5
	C$main.c$351$3$428 ==.
;	main.c:351: led1_on(); //palSetLine(LINE_SI_SCLK);
	setb	_PORTA_0
	C$main.c$352$1$422 ==.
;	main.c:352: si_write_reg(SI41XX_REG_MAIN_CONFIG, 0b000011000000000100);
	...
	lcall	_si_write_reg
	C$main.c$353$1$422 ==.
;	main.c:353: si_write_reg(SI41XX_REG_PHASE_GAIN,  0b000000000000000000);
	clr	a
	mov	_si_write_reg_PARM_2,a
	mov	(_si_write_reg_PARM_2 + 1),a
	mov	(_si_write_reg_PARM_2 + 2),a
	...
	lcall	_si_write_reg
	C$main.c$354$1$422 ==.
;	main.c:354: si_write_reg(SI41XX_REG_PWRDOWN,     0b000000000000000000);
	clr	a
	mov	_si_write_reg_PARM_2,a
	mov	(_si_write_reg_PARM_2 + 1),a
	mov	(_si_write_reg_PARM_2 + 2),a
	...
	lcall	_si_write_reg
	C$main.c$355$1$422 ==.
;	main.c:355: si_write_reg(SI41XX_REG_IF_NDIV, ndiv);
	mov	_si_write_reg_PARM_2,#0xf0
	mov	(_si_write_reg_PARM_2 + 1),#0x05
	clr	a
	mov	(_si_write_reg_PARM_2 + 2),a
	mov	(_si_write_reg_PARM_2 + 3),a
	mov	dpl,#0x05
	lcall	_si_write_reg
	C$main.c$356$1$422 ==.
;	main.c:356: si_write_reg(SI41XX_REG_IF_RDIV, rdiv);
	...
	lcall	_si_write_reg
	C$main.c$357$1$422 ==.
;	main.c:357: si_write_reg(SI41XX_REG_PWRDOWN,     0b000000000000000010);
	...
	lcall	_si_write_reg
	C$main.c$358$3$430 ==.
;	main.c:358: led2_on(); //palSetLine(LINE_SI_SENB);
	setb	_PORTA_2
	C$main.c$359$3$432 ==.
;	main.c:359: led3_on(); //palSetLine(LINE_SI_SDATA);
	setb	_PORTA_5
	C$main.c$360$3$434 ==.
;	main.c:360: led1_on(); //palSetLine(LINE_SI_SCLK);
	setb	_PORTA_0
	C$main.c$362$1$422 ==.
...
;	main.c:372: __endasm;
	...
	C$libmftypes.h$368$4$458 ==.
;	C:/Program Files (x86)/ON Semiconductor/AXSDB/libmf/include/libmftypes.h:368: EA = 1;
	setb	_EA
	C$main.c$377$1$436 ==.
;	main.c:377: flash_apply_calibration();
	lcall	_flash_apply_calibration
	C$main.c$378$1$436 ==.
;	main.c:378: CLKCON = 0x00;
	mov	_CLKCON,#0x00
	C$main.c$379$1$436 ==.
;	main.c:379: wtimer_init();
	lcall	_wtimer_init
	C$main.c$381$1$436 ==.
;	main.c:381: if (coldstart)
	mov	a,_coldstart
	jnz	00193$
	ljmp	00136$
00193$:
...
;	main.c:386: led3_off();
	clr	_PORTA_5
	C$main.c$388$2$437 ==.
;	main.c:388: wakeup_desc.handler = wakeup_callback;
	...
	movx	@dptr,a
	C$main.c$392$2$437 ==.
;	main.c:392: display_init();
	lcall	_lcd2_init
	C$main.c$393$2$437 ==.
;	main.c:393: display_setpos(0);
	mov	dpl,#0x00
	lcall	_lcd2_setpos
	C$main.c$394$2$437 ==.
;	main.c:394: i = axradio_init();
	lcall	_axradio_init
	C$main.c$396$2$437 ==.
;	main.c:396: if (i != AXRADIO_ERR_NOERROR)
	mov	a,dpl
	mov	r7,a
	jz	00128$
	C$main.c$398$3$446 ==.
;	main.c:398: if (i == AXRADIO_ERR_NOCHIP)
	cjne	r7,#0x05,00195$
	sjmp	00196$
00195$:
	ljmp	00142$
00196$:
	C$main.c$400$4$447 ==.
;	main.c:400: display_writestr(radio_not_found_lcd_display);
	mov	dptr,#_radio_not_found_lcd_display
	mov	b,#0x00
	lcall	_lcd2_writestr
	C$main.c$407$4$447 ==.
;	main.c:407: goto terminate_error;
	ljmp	00153$
	C$main.c$410$2$437 ==.
;	main.c:410: goto terminate_radio_error;
00128$:
	C$main.c$413$2$437 ==.
;	main.c:413: display_writestr(radio_lcd_display);
	mov	dptr,#_radio_lcd_display
	mov	b,#0x00
	lcall	_lcd2_writestr
	C$main.c$420$2$437 ==.
;	main.c:420: axradio_set_local_address(&localaddr);
	mov	dptr,#_localaddr
	mov	b,#0x80
	lcall	_axradio_set_local_address
	C$main.c$421$2$437 ==.
;	main.c:421: axradio_set_default_remote_address(&remoteaddr);
	mov	dptr,#_remoteaddr
	mov	b,#0x80
	lcall	_axradio_set_default_remote_address
	C$main.c$435$2$437 ==.
;	main.c:435: display_writestr("RNG=");
	mov	dptr,#___str_1
	mov	b,#0x80
	lcall	_lcd2_writestr
	C$main.c$436$2$437 ==.
;	main.c:436: display_writenum16(axradio_get_pllrange(), 2, 0);
	...
	dec	sp
	C$main.c$438$3$448 ==.
;	main.c:438: uint8_t x = axradio_get_pllvcoi();
	lcall	_axradio_get_pllvcoi
	C$main.c$440$3$448 ==.
;	main.c:440: if (x & 0x80)
	mov	a,dpl
	mov	r6,a
	jnb	acc.7,00130$
	C$main.c$442$4$449 ==.
;	main.c:442: display_writestr(" VCOI=");
	mov	dptr,#___str_2
	mov	b,#0x80
	push	ar6
	lcall	_lcd2_writestr
	pop	ar6
	C$main.c$443$4$449 ==.
;	main.c:443: display_writehex16(x, 2, 0);
	clr	a
	mov	r5,a
	push	acc
	mov	a,#0x02
...
00130$:
	C$main.c$446$2$437 ==.
;	main.c:446: delay_ms(10000); /* just to show PLL RNG */
	mov	dptr,#0x2710
	lcall	_delay_ms
	C$main.c$447$2$437 ==.
;	main.c:447: display_clear(0, 16);
	mov	a,#0x10
	push	acc
	mov	dpl,#0x00
	lcall	_lcd2_clear
	dec	sp
	C$main.c$448$2$437 ==.
;	main.c:448: display_clear(0x40, 16);
	mov	a,#0x10
	push	acc
	mov	dpl,#0x40
	lcall	_lcd2_clear
	dec	sp
	C$main.c$449$2$437 ==.
;	main.c:449: display_setpos(0);
	mov	dpl,#0x00
	lcall	_lcd2_setpos
	C$main.c$450$2$437 ==.
;	main.c:450: display_writestr("MASTer");
	mov	dptr,#___str_3
	mov	b,#0x80
	lcall	_lcd2_writestr
	C$main.c$471$2$437 ==.
;	main.c:471: i = axradio_set_mode(RADIO_MODE);
	mov	dpl,#0x10
	lcall	_axradio_set_mode
	C$main.c$473$2$437 ==.
;	main.c:473: if (i != AXRADIO_ERR_NOERROR)
	mov	a,dpl
	mov	r7,a
	jz	00198$
	ljmp	00142$
00198$:
	C$main.c$477$2$437 ==.
;	main.c:477: wakeup_desc.time = wtimer0_correctinterval(WTIMER0_PERIOD);
	mov	dptr,#0x0500
	clr	a
	mov	b,a
	lcall	_wtimer0_correctinterval
	...
	movx	@dptr,a
	C$main.c$478$2$437 ==.
;	main.c:478: wtimer0_addrelative(&wakeup_desc);
	mov	dptr,#_wakeup_desc
	lcall	_wtimer0_addrelative
	C$main.c$481$2$437 ==.
;	main.c:481: if (init_synth_only_once == 1)
	mov	a,#0x01
	cjne	a,_init_synth_only_once,00137$
	C$main.c$483$3$450 ==.
;	main.c:483: delay_ms(500);
	mov	dptr,#0x01f4
	lcall	_delay_ms
	C$main.c$484$3$450 ==.
;	main.c:484: synth_init(); //initialize synthesizer.
	lcall	_synth_init
	C$main.c$485$3$450 ==.
;	main.c:485: delay_ms(750);
	mov	dptr,#0x02ee
	lcall	_delay_ms
	C$main.c$486$3$450 ==.
;	main.c:486: init_synth_only_once = 0;
	mov	_init_synth_only_once,#0x00
	sjmp	00137$
00136$:
	C$main.c$492$2$451 ==.
;	main.c:492: axradio_commsleepexit();
	lcall	_axradio_commsleepexit
	C$main.c$493$2$451 ==.
;	main.c:493: IE_4 = 1; /* enable radio interrupt */
	setb	_IE_4
00137$:
	C$main.c$496$1$436 ==.
;	main.c:496: axradio_setup_pincfg2();
	lcall	_axradio_setup_pincfg2
00151$:
	C$main.c$504$2$452 ==.
;	main.c:504: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$libmftypes.h$373$5$461 ==.
