...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_PKTLENOFFSET   ,                              			0xF0);
	radio_write8(AX5043_REG_PKTMAXLEN      ,                              			0xF0);
...
const uint8_t __code axradio_framing_lenoffs = 240;
...
const uint32_t __code axradio_sync_slave_rxtimeout = 1295; // 39.5ms, maximum duration of a packet
