...
;	..\AX_Radio_Lab_output\config.c:22: radio_write8(AX5043_REG_WAKEUPXOEARLY  ,                              			0x01);
	...
	movx	@dptr,a
	C$config.c$23$2$180 ==.
;	..\AX_Radio_Lab_output\config.c:23: radio_write8(AX5043_REG_IFFREQ1        ,                              			0x11);
	mov	dptr,#0x4100
	mov	a,#0x11
	movx	@dptr,a
	C$config.c$24$2$181 ==.
;	..\AX_Radio_Lab_output\config.c:24: radio_write8(AX5043_REG_IFFREQ0        ,                              			0x98);
	mov	dptr,#0x4101
	mov	a,#0x98
	movx	@dptr,a
	C$config.c$25$2$182 ==.
...
;	..\AX_Radio_Lab_output\config.c:32: radio_write8(AX5043_REG_MAXRFOFFSET2   ,                              			0x80);
	...
	movx	@dptr,a
	C$config.c$33$2$190 ==.
;	..\AX_Radio_Lab_output\config.c:33: radio_write8(AX5043_REG_MAXRFOFFSET1   ,                              			0x03);
	mov	dptr,#0x410a
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$34$2$191 ==.
;	..\AX_Radio_Lab_output\config.c:34: radio_write8(AX5043_REG_MAXRFOFFSET0   ,                              			0xBE);
	mov	dptr,#0x410b
	mov	a,#0xbe
	movx	@dptr,a
	C$config.c$35$2$192 ==.
...
;	..\AX_Radio_Lab_output\config.c:47: radio_write8(AX5043_REG_FREQUENCYGAINB0,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$48$2$205 ==.
;	..\AX_Radio_Lab_output\config.c:48: radio_write8(AX5043_REG_FREQUENCYGAINC0,                              			0x05);
	mov	dptr,#0x4129
	mov	a,#0x05
	movx	@dptr,a
	C$config.c$49$2$206 ==.
;	..\AX_Radio_Lab_output\config.c:49: radio_write8(AX5043_REG_FREQUENCYGAIND0,                              			0x05);
	mov	dptr,#0x412a
	movx	@dptr,a
	C$config.c$50$2$207 ==.
...
;	..\AX_Radio_Lab_output\config.c:62: radio_write8(AX5043_REG_FREQUENCYGAINB1,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$63$2$220 ==.
;	..\AX_Radio_Lab_output\config.c:63: radio_write8(AX5043_REG_FREQUENCYGAINC1,                              			0x05);
	mov	dptr,#0x4139
	mov	a,#0x05
	movx	@dptr,a
	C$config.c$64$2$221 ==.
;	..\AX_Radio_Lab_output\config.c:64: radio_write8(AX5043_REG_FREQUENCYGAIND1,                              			0x05);
	mov	dptr,#0x413a
	movx	@dptr,a
	C$config.c$65$2$222 ==.
...
;	..\AX_Radio_Lab_output\config.c:78: radio_write8(AX5043_REG_FREQUENCYGAINB3,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$79$2$236 ==.
;	..\AX_Radio_Lab_output\config.c:79: radio_write8(AX5043_REG_FREQUENCYGAINC3,                              			0x09);
	mov	dptr,#0x4159
	mov	a,#0x09
	movx	@dptr,a
	C$config.c$80$2$237 ==.
;	..\AX_Radio_Lab_output\config.c:80: radio_write8(AX5043_REG_FREQUENCYGAIND3,                              			0x09);
	mov	dptr,#0x415a
	movx	@dptr,a
	C$config.c$81$2$238 ==.
...
;	..\AX_Radio_Lab_output\config.c:87: radio_write8(AX5043_REG_FSKDEV2        ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$88$2$245 ==.
;	..\AX_Radio_Lab_output\config.c:88: radio_write8(AX5043_REG_FSKDEV1        ,                              			0x7A);
	mov	dptr,#0x4162
	mov	a,#0x7a
	movx	@dptr,a
	C$config.c$89$2$246 ==.
;	..\AX_Radio_Lab_output\config.c:89: radio_write8(AX5043_REG_FSKDEV0        ,                              			0xE1);
	mov	dptr,#0x4163
	mov	a,#0xe1
	movx	@dptr,a
	C$config.c$90$2$247 ==.
;	..\AX_Radio_Lab_output\config.c:90: radio_write8(AX5043_REG_MODCFGA        ,                              			0x06);
	...
	movx	@dptr,a
	C$config.c$91$2$248 ==.
;	..\AX_Radio_Lab_output\config.c:91: radio_write8(AX5043_REG_TXRATE2        ,                              			0x01);
	mov	dptr,#0x4165
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$92$2$249 ==.
;	..\AX_Radio_Lab_output\config.c:92: radio_write8(AX5043_REG_TXRATE1        ,                              			0xEB);
	mov	dptr,#0x4166
	mov	a,#0xeb
	movx	@dptr,a
	C$config.c$93$2$250 ==.
;	..\AX_Radio_Lab_output\config.c:93: radio_write8(AX5043_REG_TXRATE0        ,                              			0x85);
	mov	dptr,#0x4167
	mov	a,#0x85
	movx	@dptr,a
	C$config.c$94$2$251 ==.
...
;	..\AX_Radio_Lab_output\config.c:95: radio_write8(AX5043_REG_TXPWRCOEFFB0   ,                              			0xFF);
	...
	movx	@dptr,a
	C$config.c$96$2$253 ==.
;	..\AX_Radio_Lab_output\config.c:96: radio_write8(AX5043_REG_PLLVCOI        ,                              			0x96);
	mov	dptr,#0x4180
	mov	a,#0x96
	movx	@dptr,a
	C$config.c$97$2$254 ==.
...
_axradio_phy_chanfreq:
	.byte #0x01,#0x00,#0x90,#0x1c	; 479199233
