...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 372, 308, 362 };// 11.322ms, 9.369ms, 11.017ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 405, 277, 385 }; // 12.330ms, 8.423ms, 11.719ms
