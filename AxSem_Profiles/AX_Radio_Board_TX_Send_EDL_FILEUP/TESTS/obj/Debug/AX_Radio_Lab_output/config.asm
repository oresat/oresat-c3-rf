...
;	..\AX_Radio_Lab_output\config.c:22: radio_write8(AX5043_REG_WAKEUPXOEARLY  ,                              			0x01);
	...
	movx	@dptr,a
	C$config.c$23$2$180 ==.
;	..\AX_Radio_Lab_output\config.c:23: radio_write8(AX5043_REG_IFFREQ1        ,                              			0x0B);
	mov	dptr,#0x4100
	mov	a,#0x0b
	movx	@dptr,a
	C$config.c$24$2$181 ==.
;	..\AX_Radio_Lab_output\config.c:24: radio_write8(AX5043_REG_IFFREQ0        ,                              			0xBB);
	mov	dptr,#0x4101
	mov	a,#0xbb
	movx	@dptr,a
	C$config.c$25$2$182 ==.
;	..\AX_Radio_Lab_output\config.c:25: radio_write8(AX5043_REG_DECIMATION     ,                              			0x01);
	mov	dptr,#0x4102
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$26$2$183 ==.
;	..\AX_Radio_Lab_output\config.c:26: radio_write8(AX5043_REG_RXDATARATE2    ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$27$2$184 ==.
;	..\AX_Radio_Lab_output\config.c:27: radio_write8(AX5043_REG_RXDATARATE1    ,                              			0x64);
	mov	dptr,#0x4104
	mov	a,#0x64
	movx	@dptr,a
	C$config.c$28$2$185 ==.
;	..\AX_Radio_Lab_output\config.c:28: radio_write8(AX5043_REG_RXDATARATE0    ,                              			0x00);
	mov	dptr,#0x4105
	clr	a
	movx	@dptr,a
	C$config.c$29$2$186 ==.
...
;	..\AX_Radio_Lab_output\config.c:32: radio_write8(AX5043_REG_MAXRFOFFSET2   ,                              			0x80);
	...
	movx	@dptr,a
	C$config.c$33$2$190 ==.
;	..\AX_Radio_Lab_output\config.c:33: radio_write8(AX5043_REG_MAXRFOFFSET1   ,                              			0x01);
	mov	dptr,#0x410a
	rl	a
	movx	@dptr,a
	C$config.c$34$2$191 ==.
;	..\AX_Radio_Lab_output\config.c:34: radio_write8(AX5043_REG_MAXRFOFFSET0   ,                              			0x31);
	mov	dptr,#0x410b
	mov	a,#0x31
	movx	@dptr,a
	C$config.c$35$2$192 ==.
...
;	..\AX_Radio_Lab_output\config.c:40: radio_write8(AX5043_REG_RXPARAMSETS    ,                              			0xF4);
	...
	movx	@dptr,a
	C$config.c$41$2$198 ==.
;	..\AX_Radio_Lab_output\config.c:41: radio_write8(AX5043_REG_AGCGAIN0       ,                              			0x83);
	mov	dptr,#0x4120
	mov	a,#0x83
	movx	@dptr,a
	C$config.c$42$2$199 ==.
;	..\AX_Radio_Lab_output\config.c:42: radio_write8(AX5043_REG_AGCTARGET0     ,                              			0x84);
	...
	movx	@dptr,a
	C$config.c$43$2$200 ==.
;	..\AX_Radio_Lab_output\config.c:43: radio_write8(AX5043_REG_TIMEGAIN0      ,                              			0xC9);
	mov	dptr,#0x4124
	mov	a,#0xc9
	movx	@dptr,a
	C$config.c$44$2$201 ==.
;	..\AX_Radio_Lab_output\config.c:44: radio_write8(AX5043_REG_DRGAIN0        ,                              			0xC3);
	mov	dptr,#0x4125
	mov	a,#0xc3
	movx	@dptr,a
	C$config.c$45$2$202 ==.
;	..\AX_Radio_Lab_output\config.c:45: radio_write8(AX5043_REG_PHASEGAIN0     ,                              			0x43);
	mov	dptr,#0x4126
	mov	a,#0x43
	movx	@dptr,a
	C$config.c$46$2$203 ==.
...
;	..\AX_Radio_Lab_output\config.c:47: radio_write8(AX5043_REG_FREQUENCYGAINB0,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$48$2$205 ==.
;	..\AX_Radio_Lab_output\config.c:48: radio_write8(AX5043_REG_FREQUENCYGAINC0,                              			0x07);
	mov	dptr,#0x4129
	mov	a,#0x07
	movx	@dptr,a
	C$config.c$49$2$206 ==.
;	..\AX_Radio_Lab_output\config.c:49: radio_write8(AX5043_REG_FREQUENCYGAIND0,                              			0x07);
	mov	dptr,#0x412a
	movx	@dptr,a
	C$config.c$50$2$207 ==.
...
;	..\AX_Radio_Lab_output\config.c:53: radio_write8(AX5043_REG_BBOFFSRES0     ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$54$2$211 ==.
;	..\AX_Radio_Lab_output\config.c:54: radio_write8(AX5043_REG_AGCGAIN1       ,                              			0x83);
	mov	dptr,#0x4130
	mov	a,#0x83
	movx	@dptr,a
	C$config.c$55$2$212 ==.
...
;	..\AX_Radio_Lab_output\config.c:57: radio_write8(AX5043_REG_AGCMINMAX1     ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$58$2$215 ==.
;	..\AX_Radio_Lab_output\config.c:58: radio_write8(AX5043_REG_TIMEGAIN1      ,                              			0xC7);
	mov	dptr,#0x4134
	mov	a,#0xc7
	movx	@dptr,a
	C$config.c$59$2$216 ==.
;	..\AX_Radio_Lab_output\config.c:59: radio_write8(AX5043_REG_DRGAIN1        ,                              			0xC2);
	mov	dptr,#0x4135
	mov	a,#0xc2
	movx	@dptr,a
	C$config.c$60$2$217 ==.
;	..\AX_Radio_Lab_output\config.c:60: radio_write8(AX5043_REG_PHASEGAIN1     ,                              			0x43);
	mov	dptr,#0x4136
	mov	a,#0x43
	movx	@dptr,a
	C$config.c$61$2$218 ==.
...
;	..\AX_Radio_Lab_output\config.c:62: radio_write8(AX5043_REG_FREQUENCYGAINB1,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$63$2$220 ==.
;	..\AX_Radio_Lab_output\config.c:63: radio_write8(AX5043_REG_FREQUENCYGAINC1,                              			0x07);
	mov	dptr,#0x4139
	mov	a,#0x07
	movx	@dptr,a
	C$config.c$64$2$221 ==.
;	..\AX_Radio_Lab_output\config.c:64: radio_write8(AX5043_REG_FREQUENCYGAIND1,                              			0x07);
	mov	dptr,#0x413a
	movx	@dptr,a
	C$config.c$65$2$222 ==.
...
;	..\AX_Radio_Lab_output\config.c:66: radio_write8(AX5043_REG_FREQDEV11      ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$67$2$224 ==.
;	..\AX_Radio_Lab_output\config.c:67: radio_write8(AX5043_REG_FREQDEV01      ,                              			0x32);
	mov	dptr,#0x413d
	mov	a,#0x32
	movx	@dptr,a
	C$config.c$68$2$225 ==.
...
;	..\AX_Radio_Lab_output\config.c:73: radio_write8(AX5043_REG_AGCMINMAX3     ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$74$2$231 ==.
;	..\AX_Radio_Lab_output\config.c:74: radio_write8(AX5043_REG_TIMEGAIN3      ,                              			0xC6);
	mov	dptr,#0x4154
	mov	a,#0xc6
	movx	@dptr,a
	C$config.c$75$2$232 ==.
;	..\AX_Radio_Lab_output\config.c:75: radio_write8(AX5043_REG_DRGAIN3        ,                              			0xC1);
	mov	dptr,#0x4155
	mov	a,#0xc1
	movx	@dptr,a
	C$config.c$76$2$233 ==.
;	..\AX_Radio_Lab_output\config.c:76: radio_write8(AX5043_REG_PHASEGAIN3     ,                              			0x43);
	mov	dptr,#0x4156
	mov	a,#0x43
	movx	@dptr,a
	C$config.c$77$2$234 ==.
...
;	..\AX_Radio_Lab_output\config.c:78: radio_write8(AX5043_REG_FREQUENCYGAINB3,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$79$2$236 ==.
;	..\AX_Radio_Lab_output\config.c:79: radio_write8(AX5043_REG_FREQUENCYGAINC3,                              			0x0B);
	mov	dptr,#0x4159
	mov	a,#0x0b
	movx	@dptr,a
	C$config.c$80$2$237 ==.
;	..\AX_Radio_Lab_output\config.c:80: radio_write8(AX5043_REG_FREQUENCYGAIND3,                              			0x0B);
	mov	dptr,#0x415a
	movx	@dptr,a
	C$config.c$81$2$238 ==.
...
;	..\AX_Radio_Lab_output\config.c:82: radio_write8(AX5043_REG_FREQDEV13      ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$83$2$240 ==.
;	..\AX_Radio_Lab_output\config.c:83: radio_write8(AX5043_REG_FREQDEV03      ,                              			0x32);
	mov	dptr,#0x415d
	mov	a,#0x32
	movx	@dptr,a
	C$config.c$84$2$241 ==.
...
;	..\AX_Radio_Lab_output\config.c:85: radio_write8(AX5043_REG_BBOFFSRES3     ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$86$2$243 ==.
;	..\AX_Radio_Lab_output\config.c:86: radio_write8(AX5043_REG_MODCFGF        ,                              			0x03);
	mov	dptr,#0x4160
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$87$2$244 ==.
;	..\AX_Radio_Lab_output\config.c:87: radio_write8(AX5043_REG_FSKDEV2        ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$88$2$245 ==.
;	..\AX_Radio_Lab_output\config.c:88: radio_write8(AX5043_REG_FSKDEV1        ,                              			0x28);
	mov	dptr,#0x4162
	mov	a,#0x28
	movx	@dptr,a
	C$config.c$89$2$246 ==.
;	..\AX_Radio_Lab_output\config.c:89: radio_write8(AX5043_REG_FSKDEV0        ,                              			0xF6);
	mov	dptr,#0x4163
	mov	a,#0xf6
	movx	@dptr,a
	C$config.c$90$2$247 ==.
...
;	..\AX_Radio_Lab_output\config.c:91: radio_write8(AX5043_REG_TXRATE2        ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$92$2$249 ==.
;	..\AX_Radio_Lab_output\config.c:92: radio_write8(AX5043_REG_TXRATE1        ,                              			0xA3);
	mov	dptr,#0x4166
	mov	a,#0xa3
	movx	@dptr,a
	C$config.c$93$2$250 ==.
;	..\AX_Radio_Lab_output\config.c:93: radio_write8(AX5043_REG_TXRATE0        ,                              			0xD7);
	mov	dptr,#0x4167
	mov	a,#0xd7
	movx	@dptr,a
	C$config.c$94$2$251 ==.
;	..\AX_Radio_Lab_output\config.c:94: radio_write8(AX5043_REG_TXPWRCOEFFB1   ,                              			0x0F);
	mov	dptr,#0x416a
	mov	a,#0x0f
	movx	@dptr,a
	C$config.c$95$2$252 ==.
;	..\AX_Radio_Lab_output\config.c:95: radio_write8(AX5043_REG_TXPWRCOEFFB0   ,                              			0xFF);
	mov	dptr,#0x416b
	mov	a,#0xff
	movx	@dptr,a
	C$config.c$96$2$253 ==.
;	..\AX_Radio_Lab_output\config.c:96: radio_write8(AX5043_REG_PLLVCOI        ,                              			0x98);
	mov	dptr,#0x4180
	mov	a,#0x98
	movx	@dptr,a
	C$config.c$97$2$254 ==.
;	..\AX_Radio_Lab_output\config.c:97: radio_write8(AX5043_REG_PLLRNGCLK      ,                              			0x05);
	mov	dptr,#0x4183
	mov	a,#0x05
	movx	@dptr,a
	C$config.c$98$2$255 ==.
;	..\AX_Radio_Lab_output\config.c:98: radio_write8(AX5043_REG_BBTUNE         ,                              			0x02);
	mov	dptr,#0x4188
	mov	a,#0x02
	movx	@dptr,a
	C$config.c$99$2$256 ==.
...
;	..\AX_Radio_Lab_output\config.c:100: radio_write8(AX5043_REG_PKTADDRCFG     ,                              			0x01);
	mov	dptr,#0x4200
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$101$2$258 ==.
;	..\AX_Radio_Lab_output\config.c:101: radio_write8(AX5043_REG_PKTLENCFG      ,                              			0x80);
	mov	dptr,#0x4201
	rr	a
	movx	@dptr,a
	C$config.c$102$2$259 ==.
;	..\AX_Radio_Lab_output\config.c:102: radio_write8(AX5043_REG_PKTLENOFFSET   ,                              			0x00);
	mov	dptr,#0x4202
	clr	a
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:108: radio_write8(AX5043_REG_MATCH1PAT1     ,                              			0x55);
	mov	dptr,#0x4218
	mov	a,#0x55
	movx	@dptr,a
	C$config.c$109$2$266 ==.
;	..\AX_Radio_Lab_output\config.c:109: radio_write8(AX5043_REG_MATCH1PAT0     ,                              			0x55);
	mov	dptr,#0x4219
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:112: radio_write8(AX5043_REG_TMGTXBOOST     ,                              			0x5B);
	mov	dptr,#0x4220
	mov	a,#0x5b
	movx	@dptr,a
	C$config.c$113$2$270 ==.
;	..\AX_Radio_Lab_output\config.c:113: radio_write8(AX5043_REG_TMGTXSETTLE    ,                              			0x3E);
	mov	dptr,#0x4221
	mov	a,#0x3e
	movx	@dptr,a
	C$config.c$114$2$271 ==.
;	..\AX_Radio_Lab_output\config.c:114: radio_write8(AX5043_REG_TMGRXBOOST     ,                              			0x5B);
	mov	dptr,#0x4223
	mov	a,#0x5b
	movx	@dptr,a
	C$config.c$115$2$272 ==.
;	..\AX_Radio_Lab_output\config.c:115: radio_write8(AX5043_REG_TMGRXSETTLE    ,                              			0x3E);
	mov	dptr,#0x4224
	mov	a,#0x3e
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:117: radio_write8(AX5043_REG_TMGRXCOARSEAGC ,                              			0x9C);
	mov	dptr,#0x4226
	mov	a,#0x9c
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:120: radio_write8(AX5043_REG_RSSIABSTHR     ,                              			0xEB);
	mov	dptr,#0x422d
	mov	a,#0xeb
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:136: radio_write8(AX5043_REG_0xF35          ,                              			0x11);
	mov	dptr,#0x4f35
	mov	a,#0x11
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:156: radio_write8(AX5043_REG_PLLVCODIV      ,                              			0x25);
	mov	dptr,#0x4032
	mov	a,#0x25
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:184: radio_write8(AX5043_REG_AGCGAIN3,                 0xA5);
	mov	dptr,#0x4150
	mov	a,#0xa5
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:618: CONSTMULFIX24(0x597a7e);
	mov r0,dpl 
	mov r1,dph 
	mov r2,b 
	mov r3,a 
...
;	..\AX_Radio_Lab_output\config.c:630: CONSTMULFIX24(0x2dc6c00);
	mov r0,dpl 
	mov r1,dph 
	mov r2,b 
	mov r3,a 
...
;	..\AX_Radio_Lab_output\config.c:657: dt >>= 6;
	mov	a,r5
	mov	c,acc.7
	xch	a,r4
	rlc	a
...
;	..\AX_Radio_Lab_output\config.c:659: dt >>= 2;
	mov	a,r7
	mov	r3,a
	mov	c,acc.7
	rrc	a
...
_axradio_phy_chanfreq:
	.byte #0x01,#0x00,#0x18,#0x09	; 152567809
...
_axradio_sync_slave_rxwindow:
	.byte #0x96,#0x00,#0x00,#0x00	; 150
	.byte #0x36,#0x00,#0x00,#0x00	; 54
...
G$axradio_fxtal$0$0 == .
_axradio_fxtal:
	.byte #0x00,#0x6c,#0xdc,#0x02	; 48000000
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
