...
_acquire_agc::
	.ds 1
Lmain.process_ber$databyte$6$349==.
_process_ber_databyte_6_349:
	.ds 1
...
;databyte                  Allocated with name '_process_ber_databyte_6_349'
...
00104$:
	C$main.c$220$6$349 ==.
;	main.c:220: uint8_t databyte = *p++;
	mov	dpl,_process_ber_sloc1_1_0
	mov	dph,(_process_ber_sloc1_1_0 + 1)
	movx	a,@dptr
	mov	_process_ber_databyte_6_349,a
	inc	dptr
	mov	_process_ber_sloc1_1_0,dpl
	mov	(_process_ber_sloc1_1_0 + 1),dph
	C$main.c$222$6$349 ==.
;	main.c:222: errors2 += hweight8(databyte ^ 0x87);
	mov	a,#0x87
	xrl	a,_process_ber_databyte_6_349
	mov	dpl,a
	lcall	_hweight8
	mov	r0,dpl
	clr	a
	...
	mov	(_errors2 + 3),a
	C$main.c$223$6$349 ==.
;	main.c:223: errors += hweight8(databyte ^ 0xe1);
	mov	a,#0xe1
	xrl	a,_process_ber_databyte_6_349
	mov	dpl,a
	lcall	_hweight8
...
;	main.c:232: uint8_t databyte = *p++;
	...
	mov	r7,dph
	C$main.c$233$5$350 ==.
;	main.c:233: errors += hweight8(databyte ^ 0x55);
	mov	a,#0x55
	xrl	a,r4
	mov	dpl,a
	lcall	_hweight8
...
;	main.c:375: break;
	ljmp	00161$
	C$main.c$430$3$366 ==.
;	main.c:430: case TX_USER_DEF_PATTERN:
00127$:
	C$main.c$432$4$372 ==.
;	main.c:432: axradio_transmit((void *)0, txpattern, sizeof(txpattern));
	mov	_axradio_transmit_PARM_2,#_txpattern
	mov	(_axradio_transmit_PARM_2 + 1),#(_txpattern >> 8)
