...
// TX: fcarrier=436.500MHz dev=  2.400kHz br=  9.600kBit/s pwr= 15.0dBm
// RX: fcarrier=436.500MHz bw= 14.400kHz br=  9.600kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_IFFREQ1        ,                              			0x02);
	radio_write8(AX5043_REG_IFFREQ0        ,                              			0x0C);
	radio_write8(AX5043_REG_DECIMATION     ,                              			0x14);
	radio_write8(AX5043_REG_RXDATARATE2    ,                              			0x00);
	radio_write8(AX5043_REG_RXDATARATE1    ,                              			0x3E);
	radio_write8(AX5043_REG_RXDATARATE0    ,                              			0x80);
	...
	radio_write8(AX5043_REG_MAXRFOFFSET1   ,                              			0x01);
	radio_write8(AX5043_REG_MAXRFOFFSET0   ,                              			0x31);
	...
	radio_write8(AX5043_REG_FREQUENCYGAINC0,                              			0x0A);
	radio_write8(AX5043_REG_FREQUENCYGAIND0,                              			0x0A);
	...
	radio_write8(AX5043_REG_FREQUENCYGAINC1,                              			0x0A);
	radio_write8(AX5043_REG_FREQUENCYGAIND1,                              			0x0A);
	radio_write8(AX5043_REG_AMPLITUDEGAIN1 ,                              			0x06);
	radio_write8(AX5043_REG_FREQDEV11      ,                              			0x00);
	radio_write8(AX5043_REG_FREQDEV01      ,                              			0x32);
	...
	radio_write8(AX5043_REG_FREQUENCYGAINC3,                              			0x0D);
	radio_write8(AX5043_REG_FREQUENCYGAIND3,                              			0x0D);
	radio_write8(AX5043_REG_AMPLITUDEGAIN3 ,                              			0x06);
	radio_write8(AX5043_REG_FREQDEV13      ,                              			0x00);
	radio_write8(AX5043_REG_FREQDEV03      ,                              			0x32);
	...
	radio_write8(AX5043_REG_PKTLENOFFSET   ,                              			0x12);
	...
	radio_write8(AX5043_REG_TMGTXBOOST     ,                              			0x5B);
	radio_write8(AX5043_REG_TMGTXSETTLE    ,                              			0x3E);
	radio_write8(AX5043_REG_TMGRXBOOST     ,                              			0x5B);
	radio_write8(AX5043_REG_TMGRXSETTLE    ,                              			0x3E);
	radio_write8(AX5043_REG_TMGRXOFFSACQ   ,                              			0x00);
	radio_write8(AX5043_REG_TMGRXCOARSEAGC ,                              			0x9C);
...
__reentrantb void ax5043_set_registers_rx(void) __reentrant
{
	...
	radio_write8(AX5043_REG_PLLVCODIV      ,                              			0x25);
	radio_write8(AX5043_REG_XTALCAP        ,                              			0x00);
	radio_write8(AX5043_REG_0xF00          ,                              			0x0F);
...
{
	radio_write8(AX5043_REG_TMGRXAGC,                 0x31);
...
__reentrantb void ax5043_set_registers_rxcont_singleparamset(void) __reentrant
{
	...
	radio_write8(AX5043_REG_AGCGAIN3,                 0xE7);
}
...
const uint32_t __code axradio_phy_chanfreq[1] = { 0x09180001 };
const uint16_t __code axradio_phy_chanpllrnginit[1] = { 0x0a };
...
const int32_t __code axradio_phy_maxfreqoffset = 915;
...
const uint16_t __code axradio_phy_preamble_wor_longlen = 10; // wor_longlen + wor_len totals to 240.0ms plus 400bits
...
const uint8_t __code axradio_phy_preamble_appendpattern = 0x03;
...
const uint8_t __code axradio_framing_lenoffs = 18;
...
const uint32_t __code axradio_framing_ack_timeout = 39; // 58.2ms in wtimer0 units (640Hz)
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 1577, 1529, 1574 };// 48.103ms, 46.638ms, 48.012ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 1591, 1495, 1585 }; // 48.530ms, 45.601ms, 48.349ms
const uint32_t __code axradio_sync_slave_rxtimeout = 2028; // 61.9ms, maximum duration of a packet
const uint16_t __code axradio_lposckfiltmax = 0xaec;
const uint32_t __code axradio_fxtal = 	48000000;
