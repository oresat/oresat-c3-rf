...
;	..\AX_Radio_Lab_output\config.c:22: radio_write8(AX5043_REG_WAKEUPXOEARLY  ,                              			0x01);
	...
	movx	@dptr,a
	C$config.c$23$2$180 ==.
;	..\AX_Radio_Lab_output\config.c:23: radio_write8(AX5043_REG_IFFREQ1        ,                              			0x02);
	mov	dptr,#0x4100
	inc	a
	movx	@dptr,a
	C$config.c$24$2$181 ==.
;	..\AX_Radio_Lab_output\config.c:24: radio_write8(AX5043_REG_IFFREQ0        ,                              			0x0C);
	mov	dptr,#0x4101
	mov	a,#0x0c
	movx	@dptr,a
	C$config.c$25$2$182 ==.
;	..\AX_Radio_Lab_output\config.c:25: radio_write8(AX5043_REG_DECIMATION     ,                              			0x14);
	mov	dptr,#0x4102
	mov	a,#0x14
	movx	@dptr,a
	C$config.c$26$2$183 ==.
;	..\AX_Radio_Lab_output\config.c:26: radio_write8(AX5043_REG_RXDATARATE2    ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$27$2$184 ==.
;	..\AX_Radio_Lab_output\config.c:27: radio_write8(AX5043_REG_RXDATARATE1    ,                              			0x3E);
	mov	dptr,#0x4104
	mov	a,#0x3e
	movx	@dptr,a
	C$config.c$28$2$185 ==.
;	..\AX_Radio_Lab_output\config.c:28: radio_write8(AX5043_REG_RXDATARATE0    ,                              			0x80);
	mov	dptr,#0x4105
	mov	a,#0x80
	movx	@dptr,a
	C$config.c$29$2$186 ==.
...
;	..\AX_Radio_Lab_output\config.c:40: radio_write8(AX5043_REG_RXPARAMSETS    ,                              			0xF4);
	...
	movx	@dptr,a
	C$config.c$41$2$198 ==.
;	..\AX_Radio_Lab_output\config.c:41: radio_write8(AX5043_REG_AGCGAIN0       ,                              			0xC5);
	mov	dptr,#0x4120
	mov	a,#0xc5
	movx	@dptr,a
	C$config.c$42$2$199 ==.
;	..\AX_Radio_Lab_output\config.c:42: radio_write8(AX5043_REG_AGCTARGET0     ,                              			0x84);
	...
	movx	@dptr,a
	C$config.c$43$2$200 ==.
;	..\AX_Radio_Lab_output\config.c:43: radio_write8(AX5043_REG_TIMEGAIN0      ,                              			0xF8);
	mov	dptr,#0x4124
	mov	a,#0xf8
	movx	@dptr,a
	C$config.c$44$2$201 ==.
;	..\AX_Radio_Lab_output\config.c:44: radio_write8(AX5043_REG_DRGAIN0        ,                              			0xF2);
	mov	dptr,#0x4125
	mov	a,#0xf2
	movx	@dptr,a
	C$config.c$45$2$202 ==.
...
;	..\AX_Radio_Lab_output\config.c:47: radio_write8(AX5043_REG_FREQUENCYGAINB0,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$48$2$205 ==.
;	..\AX_Radio_Lab_output\config.c:48: radio_write8(AX5043_REG_FREQUENCYGAINC0,                              			0x0A);
	mov	dptr,#0x4129
	mov	a,#0x0a
	movx	@dptr,a
	C$config.c$49$2$206 ==.
;	..\AX_Radio_Lab_output\config.c:49: radio_write8(AX5043_REG_FREQUENCYGAIND0,                              			0x0A);
	mov	dptr,#0x412a
	movx	@dptr,a
	C$config.c$50$2$207 ==.
...
;	..\AX_Radio_Lab_output\config.c:53: radio_write8(AX5043_REG_BBOFFSRES0     ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$54$2$211 ==.
;	..\AX_Radio_Lab_output\config.c:54: radio_write8(AX5043_REG_AGCGAIN1       ,                              			0xC5);
	mov	dptr,#0x4130
	mov	a,#0xc5
	movx	@dptr,a
	C$config.c$55$2$212 ==.
...
;	..\AX_Radio_Lab_output\config.c:57: radio_write8(AX5043_REG_AGCMINMAX1     ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$58$2$215 ==.
;	..\AX_Radio_Lab_output\config.c:58: radio_write8(AX5043_REG_TIMEGAIN1      ,                              			0xF6);
	mov	dptr,#0x4134
	mov	a,#0xf6
	movx	@dptr,a
	C$config.c$59$2$216 ==.
;	..\AX_Radio_Lab_output\config.c:59: radio_write8(AX5043_REG_DRGAIN1        ,                              			0xF1);
	mov	dptr,#0x4135
	mov	a,#0xf1
	movx	@dptr,a
	C$config.c$60$2$217 ==.
...
;	..\AX_Radio_Lab_output\config.c:62: radio_write8(AX5043_REG_FREQUENCYGAINB1,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$63$2$220 ==.
;	..\AX_Radio_Lab_output\config.c:63: radio_write8(AX5043_REG_FREQUENCYGAINC1,                              			0x0A);
	mov	dptr,#0x4139
	mov	a,#0x0a
	movx	@dptr,a
	C$config.c$64$2$221 ==.
;	..\AX_Radio_Lab_output\config.c:64: radio_write8(AX5043_REG_FREQUENCYGAIND1,                              			0x0A);
	mov	dptr,#0x413a
	movx	@dptr,a
	C$config.c$65$2$222 ==.
...
;	..\AX_Radio_Lab_output\config.c:73: radio_write8(AX5043_REG_AGCMINMAX3     ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$74$2$231 ==.
;	..\AX_Radio_Lab_output\config.c:74: radio_write8(AX5043_REG_TIMEGAIN3      ,                              			0xF5);
	mov	dptr,#0x4154
	mov	a,#0xf5
	movx	@dptr,a
	C$config.c$75$2$232 ==.
;	..\AX_Radio_Lab_output\config.c:75: radio_write8(AX5043_REG_DRGAIN3        ,                              			0xF0);
	mov	dptr,#0x4155
	mov	a,#0xf0
	movx	@dptr,a
	C$config.c$76$2$233 ==.
...
;	..\AX_Radio_Lab_output\config.c:78: radio_write8(AX5043_REG_FREQUENCYGAINB3,                              			0x1F);
	...
	movx	@dptr,a
	C$config.c$79$2$236 ==.
;	..\AX_Radio_Lab_output\config.c:79: radio_write8(AX5043_REG_FREQUENCYGAINC3,                              			0x0D);
	mov	dptr,#0x4159
	mov	a,#0x0d
	movx	@dptr,a
	C$config.c$80$2$237 ==.
;	..\AX_Radio_Lab_output\config.c:80: radio_write8(AX5043_REG_FREQUENCYGAIND3,                              			0x0D);
	mov	dptr,#0x415a
	movx	@dptr,a
	C$config.c$81$2$238 ==.
...
;	..\AX_Radio_Lab_output\config.c:87: radio_write8(AX5043_REG_FSKDEV2        ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$88$2$245 ==.
;	..\AX_Radio_Lab_output\config.c:88: radio_write8(AX5043_REG_FSKDEV1        ,                              			0x03);
	mov	dptr,#0x4162
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$89$2$246 ==.
;	..\AX_Radio_Lab_output\config.c:89: radio_write8(AX5043_REG_FSKDEV0        ,                              			0x47);
	mov	dptr,#0x4163
	mov	a,#0x47
	movx	@dptr,a
	C$config.c$90$2$247 ==.
...
;	..\AX_Radio_Lab_output\config.c:91: radio_write8(AX5043_REG_TXRATE2        ,                              			0x00);
	...
	movx	@dptr,a
	C$config.c$92$2$249 ==.
;	..\AX_Radio_Lab_output\config.c:92: radio_write8(AX5043_REG_TXRATE1        ,                              			0x0D);
	mov	dptr,#0x4166
	mov	a,#0x0d
	movx	@dptr,a
	C$config.c$93$2$250 ==.
;	..\AX_Radio_Lab_output\config.c:93: radio_write8(AX5043_REG_TXRATE0        ,                              			0x1B);
	mov	dptr,#0x4167
	mov	a,#0x1b
	movx	@dptr,a
	C$config.c$94$2$251 ==.
...
;	..\AX_Radio_Lab_output\config.c:97: radio_write8(AX5043_REG_PLLRNGCLK      ,                              			0x05);
	...
	movx	@dptr,a
	C$config.c$98$2$255 ==.
;	..\AX_Radio_Lab_output\config.c:98: radio_write8(AX5043_REG_BBTUNE         ,                              			0x0F);
	mov	dptr,#0x4188
	mov	a,#0x0f
	movx	@dptr,a
	C$config.c$99$2$256 ==.
...
;	..\AX_Radio_Lab_output\config.c:100: radio_write8(AX5043_REG_PKTADDRCFG     ,                              			0x00);
	mov	dptr,#0x4200
	clr	a
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:102: radio_write8(AX5043_REG_PKTLENOFFSET   ,                              			0x12);
	mov	dptr,#0x4202
	mov	a,#0x12
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:120: radio_write8(AX5043_REG_RSSIABSTHR     ,                              			0xE3);
	mov	dptr,#0x422d
	mov	a,#0xe3
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:154: radio_write8(AX5043_REG_PLLLOOP        ,                              			0x0B);
	mov	dptr,#0x4030
	mov	a,#0x0b
	movx	@dptr,a
	C$config.c$155$2$306 ==.
;	..\AX_Radio_Lab_output\config.c:155: radio_write8(AX5043_REG_PLLCPI         ,                              			0x10);
	mov	dptr,#0x4031
	mov	a,#0x10
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:165: radio_write8(AX5043_REG_TMGRXAGC,                 0x31);
	mov	dptr,#0x4227
	mov	a,#0x31
	movx	@dptr,a
...
;	..\AX_Radio_Lab_output\config.c:184: radio_write8(AX5043_REG_AGCGAIN3,                 0xE7);
	mov	dptr,#0x4150
	mov	a,#0xe7
	movx	@dptr,a
...
_axradio_sync_slave_rxadvance:
	.byte #0x29,#0x06,#0x00,#0x00	; 1577
	.byte #0xf9,#0x05,#0x00,#0x00	; 1529
	.byte #0x26,#0x06,#0x00,#0x00	; 1574
G$axradio_sync_slave_rxwindow$0$0 == .
_axradio_sync_slave_rxwindow:
	.byte #0x37,#0x06,#0x00,#0x00	; 1591
	.byte #0xd7,#0x05,#0x00,#0x00	; 1495
	.byte #0x31,#0x06,#0x00,#0x00	; 1585
G$axradio_sync_slave_rxtimeout$0$0 == .
_axradio_sync_slave_rxtimeout:
	.byte #0xec,#0x07,#0x00,#0x00	; 2028
