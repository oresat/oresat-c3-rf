...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_IFFREQ1        ,                              			0x09);
	radio_write8(AX5043_REG_IFFREQ0        ,                              			0xA5);
	radio_write8(AX5043_REG_DECIMATION     ,                              			0x03);
	...
	radio_write8(AX5043_REG_MAXRFOFFSET0   ,                              			0x61);
	...
	radio_write8(AX5043_REG_FSKDEV1        ,                              			0x1B);
	radio_write8(AX5043_REG_FSKDEV0        ,                              			0x4F);
	radio_write8(AX5043_REG_MODCFGA        ,                              			0x06);
	radio_write8(AX5043_REG_TXRATE2        ,                              			0x00);
	radio_write8(AX5043_REG_TXRATE1        ,                              			0x51);
	radio_write8(AX5043_REG_TXRATE0        ,                              			0xEC);
...
const uint32_t __code axradio_phy_chanfreq[1] = { 0x0a855555 };
...
const int32_t __code axradio_phy_maxfreqoffset = 1059;
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 371, 307, 361 };// 11.319ms, 9.366ms, 11.013ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 404, 276, 384 }; // 12.326ms, 8.420ms, 11.714ms
const uint32_t __code axradio_sync_slave_rxtimeout = 290; // 8.8ms, maximum duration of a packet
